...
<head>
    ...
    <title>Add Expense to your Trip</title>
</head>
            ...
            <div class="login-page">
                <div class="form">
                    <form class="" method="POST">
                        <input type="number" placeholder="Amount in INR" min=0/>
                        <input type="text" placeholder="Where?" />
                        <select>
                                <option value="volvo">Person 1</option>
                                <option value="saab">Person 2</option>
                                <option value="mercedes">Person 3</option>
                                <option value="audi">Person 4</option>
                              </select>

                        <button>Add</button></form>
                    <hr>
                    <form method="POST" action="summary.jsp">
                        <button class="clr-red">End Trip</button>
                    </form>
